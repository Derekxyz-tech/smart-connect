...
export default function MessagesPage() {
  ...
  useEffect(() => {
    ...
    setUser(contextUser)
    loadConversations(contextUser.id)
    loadAvailableEleves(contextUser.id)
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-slate-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white border-b border-slate-200 pl-14 pr-4 md:px-8 py-4 shadow-sm z-10 flex items-center justify-center">
          <h1 className="text-xl font-semibold text-slate-800 tracking-tight truncate">Messages</h1>
        </header>
