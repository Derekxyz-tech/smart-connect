    ...
    <div className="h-screen flex overflow-hidden bg-slate-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white border-b border-slate-200 h-16 flex items-center relative pl-14 pr-4 md:px-8 shadow-sm z-10">
          <h2 className="text-xl font-semibold text-slate-800 tracking-tight truncate flex-1 text-center">Dates Importantes</h2>
          <button
            onClick={() => openModal()}
          ...
          >
            ...
            <span className="hidden sm:inline">Nouvelle date</span>
          </button>
        </header>
