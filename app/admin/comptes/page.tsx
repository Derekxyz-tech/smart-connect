...
export default function CreateAccountsPage() {
  ...
  useEffect(() => {
    ...
    if (!contextUser) { router.push('/login'); return }
    setUser(contextUser)
              ...
              <form id="create-account-form" onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <label
                      className={`flex items-center gap-3 p-3 sm:p-4 border-2 rounded-lg cursor-pointer hover:bg-slate-50 transition-colors min-w-0 ${
                        role === 'eleve'
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <p className="font-medium text-slate-800 text-sm sm:text-base">Élève</p>
                        <p className="text-xs text-slate-500 hidden sm:block">Créer un compte pour un élève</p>
                      </div>
                    </label>
                    <label
                      className={`flex items-center gap-3 p-3 sm:p-4 border-2 rounded-lg cursor-pointer hover:bg-slate-50 transition-colors min-w-0 ${
                    ...
                    >
                      ...
                      />
                      <div className="min-w-0">
                        <p className="font-medium text-slate-800 text-sm sm:text-base">Professeur</p>
                        <p className="text-xs text-slate-500 hidden sm:block">Créer un compte pour un professeur</p>
                      </div>
                    </label>
                  </div>
                </div>
