              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-sm text-slate-800 w-full border-slate-200 border rounded-lg pt-2.5 pr-10 pb-2.5 pl-10 shadow-sm"
                    placeholder="••••••••"
                    required
                  />
                  <button
